...
struct NoteListCard: View {
    ...
    init(configuration: NoteCardConfiguration, actions: CardActions) {
...
struct NoteCards_Previews: PreviewProvider {
    ...
    static var previews: some View {
        Group {
            NoteListCard(configuration: previewConfiguration, actions: previewActions)
                .padding()
                .previewDisplayName("List Card")
            
            NoteGridCard(configuration: previewConfiguration, actions: previewActions)
                .padding()
