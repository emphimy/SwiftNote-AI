        ...
        ZStack {
            ...
            VStack(spacing: Theme.Spacing.lg) {
                ...
                VStack(spacing: Theme.Spacing.md) {
                    ...
                    Text("After confirming your email, you'll be automatically signed in.")
        ...
        .alert(isPresented: $showingResendAlert) {
            Alert(
                ...
                primaryButton: .default(Text("Resend")) {
                    // This would typically call a method to resend the confirmation email
                    // For now, we'll just show a message
                    authManager.errorMessage = "This feature is not yet implemented"
                },
